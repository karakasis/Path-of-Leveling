...
public class GemsPanel_Controller implements Initializable {
    ...
    private void addGemPanel() {
        ...
        /*
         * if (findNextVBox() == 0) { try { leftGemBox.getChildren().add(loader.load());
         * current_sgl.gpl.loadGemPanel(0, gl.id); } catch (IOException ex) {
         * Logger.getLogger(GemsPanel_Controller.class.getName()).log(Level.SEVERE,
         * null, ex); } } else { try { rightGemBox.getChildren().add(loader.load());
         * current_sgl.gpl.loadGemPanel(1, gl.id); } catch (IOException ex) {
         * Logger.getLogger(GemsPanel_Controller.class.getName()).log(Level.SEVERE,
         * null, ex); } }
         */
        try {
