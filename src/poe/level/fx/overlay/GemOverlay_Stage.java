...
public class GemOverlay_Stage extends Stage {
    ...
    public GemOverlay_Stage(Build build) {
        ...
        // if the settings are on default load the optimized settings based on screen
        // measurements
        if (Preferences_Controller.gem_overlay_pos[0] == -200 && Preferences_Controller.gem_overlay_pos[1] == -200) {
